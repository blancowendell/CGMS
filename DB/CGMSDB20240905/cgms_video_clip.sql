...
--
-- Table structure for table `video_clip`
--
...
CREATE TABLE `video_clip` (
  ...
  CONSTRAINT `video_clip_ibfk_1` FOREIGN KEY (`vc_strandsid`) REFERENCES `academic_strands` (`as_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `video_clip`
--

LOCK TABLES `video_clip` WRITE;
/*!40000 ALTER TABLE `video_clip` DISABLE KEYS */;
/*!40000 ALTER TABLE `video_clip` ENABLE KEYS */;
UNLOCK TABLES;
