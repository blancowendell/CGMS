...
CREATE TABLE `master_students` (
  ...
  `ms_reset_password_token` varchar(255) DEFAULT NULL,
  `ms_reset_password_expires` datetime DEFAULT NULL,
  PRIMARY KEY (`ms_studentid`),
  UNIQUE KEY `ms_email_UNIQUE` (`ms_email`),
...
INSERT INTO `master_students` VALUES (3,'Wendell','Blanco','L','markanasarias6@gmail.com',1,'wblanco','542cd7af7e9c771697005ed48d97b1ac',2,NULL,NULL),(4,'Mark','Anasarias','D','wdblanco.spcpc@gmail.com',1,'marka','542cd7af7e9c771697005ed48d97b1ac',2,'377c626131c8a94431bfcaca3b5f9ee069604c8f',NULL),(5,'Jover Brylle ','Edem','De Vera','joverbrylleedem.spcpc@gmail.com',1,'Pogi123','53cab390b44c85cbd3611b866086e1dc',2,NULL,NULL);
...
-- Dump completed on 2024-10-04 21:19:54
