...
CREATE TABLE `personality_type` (
  ...
  `pt_create_date` datetime NOT NULL,
...
INSERT INTO `personality_type` VALUES (1,1,'INTJ','                                                sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample                        sample','[\"1\", \"2\"]','2024-09-11 22:29:00','Tanggol Dimaguiba');
