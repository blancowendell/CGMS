...
//   service: "gmail",
//   auth: {
//     user: "cgms.test.spcpc@gmail.com", // your email
//     pass: "bnrb nvox fezk czaa", // your email password or app password
//   },
// });
...
router.post("/reset-password", async (req, res) => {
  ...
  try {
    const sql = `SELECT * FROM master_students WHERE ms_email = '${email}'`;
      ...
      Update(updateTokenSql, async (updateErr, updateResult) => {
        ...
        const mailOptions = {
          ...
          text: `You are receiving this email because you (or someone else) have requested a password reset. \n\n` +
                ...
                `Your password reset token is: ${token}` // Include the token in the email body
        };
